...
<body>
  ...
  <div id="spinner"
    ...
    <img class="position-absolute top-50 start-50 translate-middle" src="img/minilogo.png" alt="Icon" height="90px"
      width="90px">
  </div>
      ...
      <div class="row h-100 align-items-center py-5">
        ...
        <div class="col-lg-6 d-none d-lg-block" data-aos="zoom-in-left">
          <img src="img/about2.jpeg" alt=""
            class="img-fluid border border-pigi border-top-0 border-start-0 border-bottom border-5">
        </div>
      </div>
    </div>
  </div>
    ...
    <section class="container pt-3 mb-3">
      <div class="row pt-5 mt-30 flex-row-reverse">
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
          <a class=" grow card" href="#">
            <div class="box-shadow bg-white rounded-circle mx-auto text-center"
              style="width: 90px; height: 90px; margin-top: -45px;"><i class="bi bi-1-circle-fill fa-4x head-icon"></i>
            </div>
            <div class="card-body text-center">
              ...
              </p><span class="text-sm text-uppercase font-weight-bold">المزيد&nbsp;<i
          ...
          <a class=" grow card" href="#">
            <div class="box-shadow bg-white rounded-circle mx-auto text-center"
              style="width: 90px; height: 90px; margin-top: -45px;"><i
                class="bi bi-2-circle-fill fa-4x head-icon"></i></i></div>
            <div class="card-body text-center">
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
          <a class=" grow card" href="#">
            <div class="box-shadow bg-white rounded-circle mx-auto text-center"
              style="width: 90px; height: 90px; margin-top: -45px;"><i class="bi bi-3-circle-fill fa-4x head-icon"></i>
            </div>
            <div class="card-body text-center">
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
          <a class=" grow card" href="#">
            <div class="box-shadow bg-white rounded-circle mx-auto text-center"
              style="width: 90px; height: 90px; margin-top: -45px;"><i class="bi bi-4-circle-fill fa-4x head-icon"></i>
            </div>
            <div class="card-body text-center">
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
          <a class=" grow card" href="#">
            <div class="box-shadow bg-white rounded-circle mx-auto text-center"
              style="width: 90px; height: 90px; margin-top: -45px;"><i class="bi bi-5-circle-fill fa-4x head-icon"></i>
            </div>
            <div class="card-body text-center">
        ...
        <div class="col-lg-4 col-sm-6 mb-30 pb-5" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
          <a class=" grow card" href="#">
            <div class="box-shadow bg-white rounded-circle mx-auto text-center"
              style="width: 90px; height: 90px; margin-top: -45px;"><i class="bi bi-6-circle-fill fa-4x head-icon"></i>
            </div>
            <div class="card-body text-center">
      ...
      <div class="container">
        ...
        <div class="row">
          <div data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000"
            class="col-lg-4 col-md-6 p-4">
            <img class="img-fluid d-block mb-3 mx-auto rounded-circle" alt="Card image cap" width="200"
              src="img\team1.jpeg">
            <h4> <b>م. عمر خان </b> </h4>
  ...
  <section class="page-section bg-light">
    <div class="row align-items-center">
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide text-center mb-5" data-bs-ride="carousel"
        data-aos="fade-up" data-aos-duration="3000">
        <div class="container ">
          <div class="carousel-inner p-3">
            <div class="carousel-item active ">
              <div class=" mb-2 mx-5 py-4 rounded d-inline-block "> <i> <img src="img/client-logo1.png"
                    class="d-inline-block p-3" width="200rem" height="310rem" alt="not found"></i></div>
              <div class=" mb-2 mx-5 py-4 rounded d-inline-block "> <i> <img src="img/client-logo2.png"
                    class="d-inline-block p-3" width="200rem" height="310rem" alt="not found"></i></div>
              <div class=" mb-2 mx-5 py-4 rounded d-inline-block  "> <i><img src="img/client-logo3.png"
                    class="d-inline-block p-3" width="200rem" height="310rem" alt="not found"></i></div>
              <div class=" mb-2 mx-5 py-4 rounded d-inline-block "> <i><img src="img/client-logo4.png"
                    class="d-inline-block  p-3" width="200rem" height="310rem" alt="not found"></i></div>
            </div>
            <div class="carousel-item">
              <div class=" mb-2 mx-5 py-4 rounded d-inline-block"><img src="img/client-logo3.png"
                  class="d-inline-block p-3" width="200rem" height="310rem" alt="not found"></div>
              <div class="mb-2 mx-5 py-4 rounded d-inline-block"><img src="img/client-logo2.png"
                  class="d-inline-block  p-3" width="200rem" height="310rem" alt="not found"></div>
              <div class="mb-2 mx-5 py-4 rounded d-inline-block "><img src="img/client-logo1.png"
                  class="d-inline-block p-3" width="200rem" height="310rem" alt="not found"></div>
              <div class="mb-2 mx-5 py-4 rounded d-inline-block "><img src="img/client-logo4.png"
                  class="d-inline-block p-3" width="200rem" height="310rem" alt="not found"></div>
            </div>
          </div>
        </div>
        ...
        <div class="row" style="height:190px;" data-aos="zoom-in-right">
          <div class="col-md-6 maps ">
            <iframe class="rounded "
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14858.65854069591!2d39.71574629999999!3d21.4031057!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c219f3a4451fef%3A0xdcdd5e12e717d948!2z2KPYsdi02LI!5e0!3m2!1sar!2ssa!4v1689185784981!5m2!1sar!2ssa"
              height="400" style="border:0" allowfullscreen></iframe>
            <div class="list-unstyled pb-4 mb-3 text-center font-light text-boni">
              <a href="https://www.google.com/maps/place/21%C2%B024'11.9%22N+39%C2%B042'55.1%22E/@21.4033161,39.7131082,17z/data=!3m1!4b1!4m4!3m3!8m2!3d21.4033161!4d39.7152969?hl=en-SA&entry=ttu"
                target="_blank">
          ...
          <div class="single">
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <button class="ml-2 btn bg-pigi rounded px-6 py-2 hover:bg-cohly text-light" type="submit"
                  name="Subscribe">الاشتراك</button>
              </span>
            </div>
          </div>
        </form>
