...
<body>
  ...
  <section>
    ...
    <!-- card -->
    <div data-aos="fade-up" data-aos-duration="6000" class="card-body rounded-5 mx-5 mx-md-5 shadow-5-stron " style="margin-top: -100px; background: hsla(0, 0%, 100%, 0.9); backdrop-filter: blur(50px);">
          ...
          <div class="col-lg-8">
            ...
            <form action="signUp.php" method="POST" enctype="multipart/form-data" class="text-end me-5 ms-5 needs-validation" id="signup">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-outline ">
                    ...
                    <input type="text" name="lastName" id="lastName" class="form-control text-end" value="<?php if (isset($_POST['lastName'])) {
                                                                                                            echo $_POST['lastName'];
                                                                                                          } ?>" placeholder="ادخل الاسم الاخير " required />
                  </div>
                </div>
                <div class="col-md-6 mb-4">
                  <div class="form-outline ">
                    <label class="form-label " for="firstName">الاسم الاول</label>
                    <input type="text" name="firstName" id="firstName" class="form-control text-end" value="<?php if (isset($_POST['firstName'])) {
              ...
              <div class="form-outline mb-4 text-end">
                ...
                <input type="email" name="email" id="email" class="form-control text-end" value="<?php if (isset($_POST['email'])) {
                                                                                                    echo $_POST['email'];
              ...
              <div class="form-outline mb-4">
                ...
                <input type="tel" id="phone" name="phone" class="form-control text-end" value="<?php if (isset($_POST['phone'])) {
                                                                                                  echo $_POST['phone'];
                                                                                                } ?>" placeholder="05ْX-XXX-XXXX" required />
