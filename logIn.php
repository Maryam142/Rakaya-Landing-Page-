...
<body>
  ...
  <section class=" text-end">
    <div class="p-5 bg-image text-center align-items-center"
    ...
    data-aos-duration="6000" class="card-body rounded-5 mx-5 mx-md-5 shadow-strong" style=" margin-top: -100px; background: hsla(0, 0%, 100%, 0.9); backdrop-filter: blur(50px);">
