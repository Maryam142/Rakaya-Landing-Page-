    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li ><a href="logIn.php" class="bg-boni px-3 py-2 ms-4 me-1 rounded text-light hover:bg-ramadi animate__animated animate__fadeInUp">تسجيل
              دخول </a></li>
          <li class="breadcrumb-item"><a href="signUp.php" class="bg-pigi px-3 py-2 ms-1 me-4 rounded text-light hover:bg-ramadi animate__animated animate__fadeInUp">انشاء
              حساب</a></li>
        </ul>
